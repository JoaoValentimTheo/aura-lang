...
<section class="section section--tight" style="padding-bottom:0">
  <div class="container">
    ${callout(
      "info",
      "<p>The selected <strong>runtime version</strong> is a real, immutable artifact with a recorded hash, not a label. Filesystem, clock, and sleep are unavailable here and report <code>E5002</code>; standard input and arguments work.</p>",
    )}
  </div>
</section>
